...
class CreateTblProjectComponent extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_project_component', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_project_component');
    }
}
