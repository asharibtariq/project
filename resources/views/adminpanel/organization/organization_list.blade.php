    ...
    @if(is_array($result) && count($result) > 0)
        @foreach ($result as $r)
            ...
            <tr role="row">
                ...
                <td>
                    <div class="btn-group">
                        <a onClick="return confirm('Are you sure you want to update?');" title="Edit" href="{{url('edit_organization', $r->id)}}" class="btn btn-info" id="btn-view"><i class="fa fa-edit"></i> </a>
                        <a onClick="return confirm('Are you sure you want to delete?');" title="Delete" href="{{url('delete_organization', $r->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
                    </div>
                </td>
            </tr>
            @php
