        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="add_organization">Add Organization</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form class="card-body" method="post" action="{{url('add_organization')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-4">
