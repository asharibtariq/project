            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form name="" method="post" action="{{url('update_project_director', $project->id)}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" name="name" id="name" class="form-control" value="{{$project->name}}" placeholder="Name" required>
                                        <input type="hidden" id="project_id" name="project_id" value="{{$project->project_id}}" />
                                        <input type="hidden" id="project_name" name="project_name" value="{{$project->project_name}}" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="address"  id="address"  class="form-control"
                                                  placeholder="Address" required>{{$project->address}} </textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" id="email" class="form-control"
                                               placeholder="Email" value="{{$project->email}}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! $designation_select !!}
                                        <input type="hidden" name="designation" id="designation" value="{{$project->designation}}" />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_no" id="phone_no" value="{{$project->phone_no}}" class="form-control mobile_no"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <input type="text" name="wef_date" id="wef_date" value="{{$project->wef_date}}" class="form-control datepicker" placeholder="MM/DD/YYYY" readonly required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! $organization_select !!}
                                        <input type="hidden" name="organization" id="organization" value="{{$project->organization}}"required/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"name="cell_number" id="cell_number" value="{{$project->cell_number}}" class="form-control mobile_no"
