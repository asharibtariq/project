            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <p><b>PSDP#:</b> {{$project->psdp}}</p>
                            </div>
                            <div class="col-md-4">
                                <p><b>ID#:</b> {{$project->psid}}</p>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="name" class="control-label label-paf">FY</label>
                                    {!! $fiscal_year_select !!}
                                    <input id="project_id" value="{{$project->id}}" type="hidden" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
