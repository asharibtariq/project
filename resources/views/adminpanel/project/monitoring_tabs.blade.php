...
<ul class="nav nav-pills mb-3" role="tablist">
    <li class="nav-item">
        <a class="nav-link @php echo $current_page == 'add_physical_target_status' ? 'active' : '' @endphp" href="{{url('add_physical_target_status', $physical_target_id)}}" role="tab" aria-selected="true">Physical Target Status</a>
    </li>
    <li class="nav-item">
