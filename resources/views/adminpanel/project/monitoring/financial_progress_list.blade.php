    ...
    @if(is_array($result) && count($result) > 0)
        @foreach ($result as $r)
            ...
            <tr role="row">
                ...
                <td>
                    <!--<div class="btn-group">-->
                    <a onClick="return confirm('Are you sure you want to proceed?');" title="Action" href="{{url('edit_financial_progress', $r->id)}}{{--url('edit_physical_target', $r->id)--}}" class="btn btn-info" id="btn-view"><i class="fa fa-list"></i> </a>
