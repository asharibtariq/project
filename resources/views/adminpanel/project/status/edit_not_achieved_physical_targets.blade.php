                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="consumed_budget" id="consumed_budget" value="{{ $project->consumed_budget}}" class="form-control datepicker" placeholder="MM/DD/YYYY" readonly>
                                        @if ($errors->has('consumed_budget'))
                                            <span class="text-danger">{{ $errors->first('consumed_budget') }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-4">
