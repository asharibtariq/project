        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="designation">Component List</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h5>Component</h5>
            <a href="add_component" type="button" class="btn btn-lg btn-success btn-sm"> Add Component</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="edit_component" type="button" class="btn btn-sm btn-success">Edit</a>
                                <a href="delete_component" type="button" class="btn btn-sm btn-info">Delete</a>
                            </div>
                        </td>
