...
<div class="container">
    <div class="row">
        ...
        @endif
        <div class="col-md-12">
            <a href="{{url('add_executiveagency')}}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add Executive Agency</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
<script>
    ...
    function show_ajax_cards(page='') {
        ...
        var post_data = {
            ...
            'action': "executiveagency_content"
        };
